...
# in one at a time
for coords_fp in tqdm(coords_fps):
...
print(below_5.sum(),'trips had fewer than 300 points (less than needed for a five minute trip)')

#%% remove trips with excessive speed

'''
These are ad hoc to just remove some obvious ones
...
'''
These next lines aggregate the points by user id to find the start/end time/location,
